...
interface Vm { function expectRevert() external; function store(address target, bytes32 slot, bytes32 value) external; }
...
contract PolygonForkExecutionProbe {
    ...
    function test_real_quickswap_v3_router_executes_on_polygon_fork() public {
        ...
        vm.store(NATIVE_USDC, keccak256(abi.encode(address(this), uint256(9))), bytes32(amountIn));
