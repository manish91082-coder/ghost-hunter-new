...
class S3CoverageClassificationTests(unittest.TestCase):
    ...
    def test_successful_tile_requires_explicit_complete_coverage_status(self) -> None:
        tiles = [
            {
                "status": "SUCCESS",
                ...
                "uniswap_fee_tier": 100,
            }
        ]
        coverage = summarize_s3_coverage(tiles, expected_tile_count=1)
        self.assertEqual(coverage["status"], "COMPLETE")
